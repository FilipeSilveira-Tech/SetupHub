...
async function renderFontesCategory() {
      ...
      <section class="bg-white border-bottom pb-4 pt-4 mb-4">
          <div class="container">
              <div class="d-flex align-items-center gap-3">
                  ...
                  <div>
                      <h2 class="fw-bolder text-dark mb-0">Fontes</h2>
                      <p class="text-muted mb-0">Esta categoria engloba fontes tipográficas (famílias de letras) projetadas especificamente para legibilidade e conforto visual no ambiente digital.</p>
                  </div>
              </div>
          </div>
      </section>

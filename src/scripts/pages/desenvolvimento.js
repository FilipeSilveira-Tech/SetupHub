...
async function renderdesenvolvimentoCategory() {
      ...
      <section class="bg-white border-bottom pb-4 pt-4 mb-4">
          <div class="container">
              <div class="d-flex align-items-center gap-3">
                  ...
                  <div>
                      <h2 class="fw-bolder text-dark mb-0">Desenvolvimento</h2>
                      <p class="text-muted mb-0">Software, IDEs, Linguagem de Programação e Banco de Dados Relacional</p>
                  </div>
              </div>
          </div>
      </section>
...
export { renderdesenvolvimentoCategory };

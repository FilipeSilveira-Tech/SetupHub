      ...
      <section class="bg-white border-bottom pb-4 pt-4 mb-4">
          <div class="container">
              <div class="d-flex align-items-center gap-3">
                  ...
                  <div>
                      <h2 class="fw-bolder text-dark mb-0">Segurança</h2>
                      <p class="text-muted mb-0">Softwares de segurança são ferramentas projetadas para proteger seus dados pessoais, senhas e o próprio sistema operacional contra ameaças virtuais, invasões e infecções por códigos maliciosos na internet.</p>
                  </div>
              </div>
          </div>
      </section>
